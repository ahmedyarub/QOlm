...
TestCase
{
  ...
  function init_data()
  {
    ...
    return [{tag: "datalist", listFilled: listFilled, list: list, foo1: foo1, foo2: foo2, foo3: foo3}]
  }
 ...
 {
    verify(data.listFilled.moveUp(1));

    compare(data.listFilled.get(1), foo2);
    compare(data.listFilled.get(0), foo1);
 }
 ...
 function test_MoveDown(data)
 {
    ...
    compare(data.listFilled.get(2), foo4);
    compare(data.listFilled.get(3), foo3);
 }
