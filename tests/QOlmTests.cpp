...
protected:
    ...
    NiceMock<QOlmMock<QObject>> list;
    QObject* foo1 = new QObject(&list);
    QObject* foo2 = new QObject(&list);
    QObject* foo3 = new QObject(&list);
    QObject* foo4 = new QObject(&list);
...
//    EXPECT_CALL(list, onObjectRemoved(foo2, 0, 1));
//    //EXPECT_CALL(list, onObjectAboutToBeRemoved(foo2, 0, 3));
//    //EXPECT_CALL(list, onObjectRemoved(foo2, 0, 3));
//
//    ASSERT_EQ(list.size(), 4);
//
//    bool expectedCallback = false;
